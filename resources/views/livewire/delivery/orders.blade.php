...
<div class="container-fluid py-4">
    ...
    <div class="row">
        <table>
            ...
            @endif
            <!--if ready can change it to on_way-->
            <div class="row flex justify-content-between align-items-center">


           
            @if ($order->order_status == 'ready')
            <button class="btn btn-sm btn-info" wire:click="change_order_status('on_way')">
                <h1>{{__('On Way')}}</h1>
            @endif

            <!--if on_way can change it to delivered-->
            @if ($order->order_status == 'on_way')
            <button class="btn btn-sm btn-info" wire:click="change_order_status('delivered')">
            <h1>{{__('Delivered')}}</h1>    
            </button>
            @endif
