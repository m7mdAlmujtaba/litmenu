        ...
        <div class="container-fluid py-1 px-3">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0  me-sm-4 d-flex justify-content-center " id="navbar">
                <div class=" align-items-center ">
                  <img src="{{ asset('assets/img/shop-logo.png') }}" alt="" class="w-50" width="100%" >
                </div>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
            <div id="position ">
                ...
                <input id="name" type="text" placeholder="{{__('Place Name')}}" wire:model="name" />
                @error('name')
                ...
                @enderror
                <input id="address" type="text" placeholder="{{__('Address')}}" wire:model="address" />
                @error('address')
                    <span class="error">{{ $message }}</span>
        ...
        <div class="row justify-content-center" >
                <a href="javascript:;"    class="btn btn-secondary" wire:click="addLocation()" style="width: 80%" disabled >{{__('Add New Location')}}</a> 
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
        ...
        <input type="radio" id="location{{$location->id}}" name="location" value="{{$location->id}}" wire:model="location_id" />
        <label for="location{{$location->id}}" class="">
            {{$location->name}} - {{$location->address}}
        </label>

        <!--radio button-->
        <a href="javascript:;"    class="justify-content-between " wire:click="deleteLocation({{$location->id}})"  >
      ...
      <div class="row">
        ...
        <div class="row" >
            ...
            <!--full width and height-->
             <textarea class="form-control w-100" id="note" rows="3" placeholder="{{__('Note')}}" wire:model="note"></textarea>
                @error('note')
        ...
        <div class="row" >
            <div class="col-12 text-center">
                <h3 class="text-center p-1"
                >{{__('Payment Method')}}</h3>

            
            <!--full width and height-->
              <select class="form-control w-100" id="payment_method" wire:model="payment_method">
        ...
        <div class="row" >
            ...
            <!--full width and height-->
              <a href="javascript:;"  wire:click="checkout()" class="btn bg-gradient-dark w-100 my-4 mb-2">
                {{__('Checkout')}}
              </a>
            </div>
          </div>
