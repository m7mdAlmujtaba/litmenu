...
background-image: url('/assets/img/hero-restaurants.jpg');
height: 400px;
">
...
<div class="d-flex justify-content-center align-items-center">
  <div class="text-white" style="color: white !important;">
    ...
    <h4 class="mb-3 text-white">
        {{__('order your favorite food from your favorite restaurant')}}
    </h4>
      ...
      <div class="row">
        ...
        <div class="col-xl-12   col-md-12 col-lg-12 mb-4 p-1">
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="col-4 text-end">
                            <div class=" shadow text-center border-radius-md justify-content-center align-items-center ">
       ...
       <!--pagination-->
         <div  class="d-flex justify-content-center align-items-center mt-4">
          ...
          <a href='javascript:;' wire:click='load()'  class="btn btn-outline-secondary btn-lg px-4" style="width: 80%;"
          id="loadMore">{{__('Load More')}}</a>
